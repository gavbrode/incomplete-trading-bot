...
API_KEY = "PK2G9A5JUYOEZQ7K94G9"
API_SECRET_KEY = "TteOnuAl05h4Rr8xZJmYIXe1h24XPkXKbDDvouCl"
...
limStoch = {
            'maxBuy':50, # max allowed value to buy
            'minSell':0.5  # min allowed value to sell
            }
